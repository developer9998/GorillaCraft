...
public class Constants
{
    ...
    public const string ModeGridName = "UI Parent/Item Grid";
    public const string CurrentModeName = "UI Parent/Minecraft Label";

    public const float PunishmentCooldown = 60 * 3;
    public const int PunishmentTotal = 5;
}
